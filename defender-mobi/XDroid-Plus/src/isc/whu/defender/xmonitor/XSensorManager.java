...
public class XSensorManager extends XHook {
	...
	public static List<XHook> getInstances(Object instance) {
		...
		listHook.add(new XSensorManager(Methods.getDefaultSensor, HookManager.cSensors, className));
		listHook.add(new XSensorManager(Methods.getSensorList, HookManager.cSensors, className));
		return listHook;
	}
