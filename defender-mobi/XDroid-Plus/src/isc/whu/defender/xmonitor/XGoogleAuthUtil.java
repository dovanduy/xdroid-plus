...
public class XGoogleAuthUtil extends XHook {
	...
	public static List<XHook> getInstances() {
		...
		listHook.add(new XGoogleAuthUtil(Methods.getToken, HookManager.cAccounts, "getTokenGoogle").optional());
		listHook.add(new XGoogleAuthUtil(Methods.getTokenWithNotification, HookManager.cAccounts,
