...
public class XAdvertisingIdClientInfo extends XHook {
	...
	public static List<XHook> getInstances() {
		...
		listHook.add(new XAdvertisingIdClientInfo(Methods.getId, HookManager.cIdentification, "AdvertisingId")
				.optional());
		return listHook;
	}
	...
	protected void before(XParam param) throws Throwable {
		if (mMethod == Methods.getId) {
			if (isRestricted(param))
				param.setResult(HookManager.getDefacedProp(Binder.getCallingUid(), "AdvertisingId"));
